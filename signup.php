...
<div class="container-fluid">
	<form action="" id="signup">
		...
		<div class="row justify-content-center">
			<button class="btn btn-block col-sm-5 align-self-center" style="color: #000;background-color: #159ec0"><b>Sign Up</b></button>
		</div>
	</form>
</div>
<style>
	...
	.modal-content {
		width: 100% !important;
		background-image: url(https://media.tenor.com/p0VPQGWKYqQAAAAC/city.gif);
