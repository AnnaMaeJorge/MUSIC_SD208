				...
				<tbody>
					...
					?>
						<tr data-id='<?php echo $row['id'] ?>'>
							<td><span class="btn bg-gradient-success rounded-circle d-flex justify-content-center align-items-center" style="width:30px;height:30px;z-index:2" onclick="play_music({0:{id:<?php echo $row['id'] ?>,upath:'assets/uploads/<?php echo $row['upath'] ?>'}})">
...
<div id="list_clone" class="d-none">
	<li class="list-group-item suggest-item">
		<div id="pdet" class="d-flex justify-content-between align-items-center">
			...
			<span class="btn bg-gradient-success bp rounded-circle d-flex justify-content-center align-items-center" style="width:30px;height:30px;z-index:2">
				<div class="fa fa-play text-white"></div>
			</span>
	</li>
</div>
